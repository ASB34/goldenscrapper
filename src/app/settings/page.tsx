    ...
    const fetchSettings = async () => {
      try {
        ...
        setExistingKeys({
          ...
          prestashopStoreUrl: !!data.settings.prestashopStoreUrl,
        ...
        <TabsContent value="prestashop" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure your PrestaShop store URL and API key for product publishing.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <PrestaShopKeyInput
                keyName="prestashopStoreUrl"
                label="Store URL"
                placeholder="https://goldencrafters.com"
                hasExisting={existingKeys.prestashopStoreUrl}
                onUpdate={updateSingleKey}
                type="url"
              />
              <Separator />
...
function PrestaShopKeyInput({ keyName, label, placeholder, hasExisting, onUpdate, type = 'password' }: {
  keyName: string;
  label: string;
  placeholder: string;
  hasExisting: boolean;
  ...
  return (
    <div className="space-y-2">
      ...
      {type === 'url' && (
        <p className="text-sm text-muted-foreground">
          Example: https://goldencrafters.com (without trailing slash)
        </p>
      )}
    </div>
  );
